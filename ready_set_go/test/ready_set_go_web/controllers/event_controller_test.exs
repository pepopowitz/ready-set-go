defmodule ReadySetGoWeb.EventControllerTest do
  use ReadySetGoWeb.ConnCase

  import ReadySetGo.RaceSpaceFixtures

  @create_attrs %{name: "some name", start_time: ~N[2024-06-06 15:48:00.000000], end_time: ~N[2024-06-06 15:48:00.000000]}
